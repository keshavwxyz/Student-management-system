...
ResultSetMetaData rsmd;
   DefaultTableModel dtm=new DefaultTableModel();
    public JTable() {
        initComponents();
        try{
        cn=DriverManager.getConnection("jdbc:mysql://localhost/d2138262","root","");
        ...
        /////code to find names of colums' head!!!!!!!!!!!!
        rs = stmt.executeQuery("SELECT * FROM student");
        rsmd = rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Folio", "Name", "House", "Class", "Marks", "Gender", "Grade", "Result", "ImagePath"
            }
        ));
