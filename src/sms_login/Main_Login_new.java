 ...
 * @author 12a1
 */
public class Main_Login_new extends javax.swing.JFrame {

    /**
     * Creates new form main_login
     */
    public Main_Login_new() {
        initComponents();
    ...
    public void login(String pass,String user){
        ...
        try {
            ...
            ResultSet rs;
            ps = dbconnection2.getConnection().prepareStatement(query);
...
//                    mf.nameTF.setText("Welcome "+user+"");
                    this.dispose();
            }
            else{
            ...
            Logger.getLogger(Main_Login_new.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        String user = unameTF.getText();
        String pass = String.valueOf(passPF.getPassword());
        
        main_func nc = new main_func();
        try {
            nc.lol(pass,user);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Login_new.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_Login_new().setVisible(true);
            }
        });
    }
